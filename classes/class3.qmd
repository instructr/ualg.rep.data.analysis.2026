...
## 2. Install Coding tools {#sec-install-rtools}
...
## 3. Install RStudio Desktop {#sec-install-rstudio}
...
## 5. Configure your Git identity {#sec-git-config}
...
## 6. GitHub Account and SSH Authentication {#sec-github}
...
Write the following in RStudio Terminal, and copy the output using the right mouse button "copy" option.
