...
- Jenny Bryan's *Happy Git and GitHubfor the useR* --- <https://happygitwithr.com>. Focus on chapters 1-4 for now, particularly the mental model of a repository and the commit/diff/push cycle.
